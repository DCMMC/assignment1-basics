...
from cs336_basics.nn import AdamW, CausalMultiHeadAttention, Embedding, Linear, RMSNorm, RotaryPositionalEmbedding, SwiGLU, TransformerBlock, TransformerLM, cross_entropy, data_loading, get_lr_cosine_schedule, gradient_clipping, load_checkpoint, save_checkpoint, scaled_dot_product_attention, silu, softmax
...
def run_multihead_self_attention(
    ...
    return causal_multihead_attention(in_features)
